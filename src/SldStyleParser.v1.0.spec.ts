...
import raster_without_opacity from '../data/styles/raster_without_opacity.js';
...
import functionFilterOgcArithmetic from '../data/styles/function_filter_ogc_arithmetic.js';
...
describe('SldStyleParser implements StyleParser (reading)', () => {
  ...
  describe('#readStyle', () => {
    ...
    it('can read a SLD with a function label with rounded value', async () => {
      const sld = fs.readFileSync('./data/slds/1.0/function_label_round.sld', 'utf8');
      const { output: geoStylerStyle } = await styleParser.readStyle(sld);
      expect(geoStylerStyle).toBeDefined();
