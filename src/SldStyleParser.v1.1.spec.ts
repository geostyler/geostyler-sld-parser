...
import empty_filter from '../data/styles/empty_filter.js';
import point_simplepoint from '../data/styles/point_simplepoint.js';
import line_simpleline from '../data/styles/line_simpleline.js';
import line_perpendicularOffset from '../data/styles/line_perpendicularOffset.js';
import line_graphicStroke from '../data/styles/line_graphicStroke.js';
import line_graphicStroke_externalGraphic from '../data/styles/line_graphicStroke_externalGraphic.js';
import line_graphicFill from '../data/styles/line_graphicFill.js';
import line_graphicFill_externalGraphic from '../data/styles/line_graphicFill_externalGraphic.js';
import line_groundUnitWidth from '../data/styles/line_groundUnitWidth.js';
import polygon_transparentpolygon from '../data/styles/polygon_transparentpolygon.js';
import polygon_graphicFill from '../data/styles/polygon_graphicFill.js';
import polygon_graphicFill_externalGraphic from '../data/styles/polygon_graphicFill_externalGraphic.js';
import point_styledlabel from '../data/styles/point_styledlabel.js';
import point_simpleLabel from '../data/styles/point_simpleLabel.js';
import point_simpleLabel2 from '../data/styles/point_simpleLabel2.js';
import point_simplepoint_filter from '../data/styles/point_simplepoint_filter.js';
import point_simplepoint_displacement from '../data/styles/point_simplepoint_displacement.js';
import point_simplepoint_filter_forceBools from '../data/styles/point_simplepoint_filter_forceBools.js';
import point_simplepoint_filter_forceNumerics from '../data/styles/point_simplepoint_filter_forceNumerics.js';
import point_simplepoint_nestedLogicalFilters from '../data/styles/point_simplepoint_nestedLogicalFilters.js';
import point_externalgraphic from '../data/styles/point_externalgraphic.js';
import point_externalgraphic_floatingPoint from '../data/styles/point_externalgraphic_floatingPoint.js';
import point_externalgraphic_inlineContent from '../data/styles/point_externalgraphic_inlineContent.js';
import point_externalgraphic_svg from '../data/styles/point_externalgraphic_svg.js';
import point_externalgraphic_svg_displacement from '../data/styles/point_externalgraphic_svg_displacement.js';
import multi_simplelineLabel from '../data/styles/multi_simplelineLabel.js';
import point_simplesquare from '../data/styles/point_simplesquare.js';
import point_simpletriangle from '../data/styles/point_simpletriangle.js';
import point_simplestar from '../data/styles/point_simplestar.js';
import point_simplecross from '../data/styles/point_simplecross.js';
import point_simplex from '../data/styles/point_simplex.js';
import point_simpleslash from '../data/styles/point_simpleslash.js';
import point_fontglyph from '../data/styles/point_fontglyph.js';
import point_styledLabel_literalOpenCurlyBraces from '../data/styles/point_styledLabel_literalOpenCurlyBraces.js';
import point_styledLabel_literalPlaceholder from '../data/styles/point_styledLabel_literalPlaceholder.js';
import point_styledLabel_elementOrder from '../data/styles/point_styledLabel_elementOrder.js';
import raster_simpleraster from '../data/styles/raster_simpleRaster.js';
import raster_complexraster from '../data/styles/raster_complexRaster.js';
import text_pointplacement from '../data/styles/text_pointplacement.js';
import text_pointplacement_with_anchor from '../data/styles/text_pointplacement_anchor.js';
import text_lineplacement from '../data/styles/text_lineplacement.js';
import text_lineplacement_offset from '../data/styles/text_lineplacement_offset.js';
import unsupported_properties from '../data/styles/unsupported_properties.js';
import function_markSymbolizer from '../data/styles/function_markSymbolizer.js';
import function_filter from '../data/styles/function_filter.js';
import function_nested from '../data/styles/function_nested.js';
import functionFilterPropertyToProperty from '../data/styles/function_filter_property_to_property.js';
import functionLabelRound from '../data/styles/function_label_round.js';
...
describe('SldStyleParser with Symbology Encoding implements StyleParser (writing)', () => {
  ...
  describe('#writeStyle', () => {
    ...
    it('can write a SLD 1.1 PointSymbolizer with ExternalGraphic containing InlineContent', async () => {
      const { output: sldString } = await styleParser.writeStyle(point_externalgraphic_inlineContent);
      expect(sldString).toBeDefined();
      // As string comparison between two XML-Strings is awkward and nonsens
      // we read it again and compare the json input with the parser output
      const { output: readStyle} = await styleParser.readStyle(sldString!);
